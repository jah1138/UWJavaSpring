 ...
 *
 * Examine the 'character sets' supported by the Java runtime.  Also
 * known as 'character encodings' since charsets map (encode) 16-bit
 * characters into sequences of 8-bit bytes.
 */
