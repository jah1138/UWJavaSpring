package cp125.week8;//package cp125.week8;
 ...
 * Version: 5/31/2014.
 */
public class ChatMT implements Runnable{
    ...
    public static void main (String[]args) {
        ...
        String usage = "Usage: \nTo listen: " + ChatMT.class.getName() + " port \n" +
                        "To connect: " + ChatMT.class.getName() + " host port";
